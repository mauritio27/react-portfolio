  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        I'm front-end developer based in Iasi, and I'm very
      ...
      <div className="skills">
        ...
        <div className="logos">
          <ul>
            <li><img src={html} draggable="false" alt="html logo" /></li>
            <li><img src={css} draggable="false" alt="css logo" /></li>
            <li><img src={js} draggable="false" alt="javascript logo" /></li>
            <li><img src={react} draggable="false" alt="react logo" /></li>
            <li><img src={tailwindcss} draggable="false" alt="tailwindcss logo" /></li>
            <li><img src={sass} draggable="false" alt="sass logo" /></li>
          </ul>
        </div>
      </div>
    </div>
